...
esp_err_t bsp_lcd_init(void)
{
    ...
    esp_lcd_panel_io_i80_config_t io_config = {
        ...
        .pclk_hz = 6000000, // 测试14MHz以上花屏 10MHZ=26.18fps   13MHZ=34.04fps   7~10mhz Ok
...
{
    lcd_panel_t *rm68120 = __containerof(panel, lcd_panel_t, base);
    // ESP_LOGI("lcd_debug", "%dx%d", rm68120->width, rm68120->height);
...
//     esp_lcd_panel_draw_bitmap(panel, 640, 200, 640+120, 200+39, (uint16_t *)pixels);
...
void lcd_draw_picture_test(esp_lcd_panel_t *panel)
{
    ...
    // esp_lcd_panel_draw_bitmap(panel, 640, 200, 640+120, 200+39, (uint16_t *)pixels);
    // heap_caps_free(pixels);
    uint16_t *pixels = heap_caps_malloc((640 * 1) * sizeof(uint16_t), MALLOC_CAP_8BIT | MALLOC_CAP_INTERNAL);
    ...
    //     pixels[i] = 0xF800;
    // for(int i =200;i<400;i=i+1)
    //     pixels[i] = 0x07E0;
    // for(int i =400;i<600;i=i+1)
    //     pixels[i] = 0x001F;
    for(int i =0;i<480;i=i+1)
        esp_lcd_panel_draw_bitmap(panel, 0, i, 640, i+1, (uint16_t *)pixels);
    heap_caps_free(pixels);
}
...
//     esp_lcd_panel_draw_bitmap(panel, 640, 0, 640+120, 0+39, (uint16_t *)pixels);
//     heap_caps_free(pixels);
// }
...
// static const unsigned char gImage_img_120x39[9360] =  { /* 0X00,0X10,0X78,0X00,0X27,0X00,0X01,0X1B, */ //BRG 565
